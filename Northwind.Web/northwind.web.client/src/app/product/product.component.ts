...
export class ProductComponent {
  ...
  deleteData(id: any) {
    this.ProductService.deleteData(id).subscribe((data) => {
      this.data = data;
      this.getdata();
    })
  }
  Save() {
    ...
    this.ProductService.postData(this.ProdForm.value).subscribe((data) => {
      this.data = data;
      this.resetFrom();
  ...
  Update() {
    ...
    this.ProductService.putData(this.ProdForm.value.CategoryID, this.ProdForm.value).subscribe((data) => {
      this.data = data;
      this.resetFrom();
    })
  }
  ...
  EditData(Data: {
    ProductID: any; ProductName: any; SupplierID: any; CategoryID: any; QuantityPerUnit: any;
    UnitPrice : any; UnitsInStock: any; UnitsOnOrder: any; ReorderLevel: any; Discontinued: any;}) {
